...
import com.cyberguard.platform.security.AuthEntryPointJwt;
import com.cyberguard.platform.security.CustomUserDetailsService;
import com.cyberguard.platform.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                    .requestMatchers("/api/v1/collector/**").hasAuthority("COLLECTOR_INGEST")
